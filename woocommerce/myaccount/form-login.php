...
<?php endif; ?>
			...
			<form class="woocommerce-form woocommerce-form-login login" method="post">
				...
				<span class="login-note">Log in to your account to explore all our products and shop more convenient.</span>
	...
	<div class="col-md-6">
		...
		<span class="note-register"><?php echo esc_html_e( 'If you don’t have an account. Register now!' ) ?></span>
